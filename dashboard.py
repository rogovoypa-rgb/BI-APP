...
# ==========================================
# СТРАНИЦА 1: ПРОДАЖИ (МИНИМАЛЬНАЯ ВЕРСИЯ)
# ==========================================
if page == "📈 Продажи":
    ...
    if sales_df.empty:
        ...
        required_cols = ['Выручка_без_НДС', 'Валовая_прибыль', 'Количество', 'Период.Месяц']
        ...
        # Функция для отображения метрики в маленьком блоке
