...
# ==========================================
    ...
    if logistics_df.empty:
        ...
        if percent_col:
            # Данные в столбце T уже в процентах (например, 25 = 25%)
            # Поэтому делим на 100: 25 → 0.25
        ...
        # = Фактическая цена PLM (столбец C) × процент (столбец T / 100)
        # Пример: Факт = 1000, Процент = 25 → Затраты = 1000 × 0.25 = 250
