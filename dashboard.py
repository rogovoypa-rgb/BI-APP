...
# ==========================================
# СТРАНИЦА 1: ПРОДАЖИ (С АНАЛИЗОМ ТОП-5 ПО ВЫРУЧКЕ)
# ==========================================
if page == "📈 Продажи":
    ...
    if sales_df.empty:
        ...
        def display_customer_analysis(customer_name, df_year, available_months_num, has_cost_column):
            ...
            # Формируем таблицу вручную, чтобы избежать проблем с колонками
            table_dict = {
            ...
            if has_cost_column and 'Себестоимость' in customer_monthly.columns:
                table_dict['Себестоимость'] = [f"{format_number(x)} ₽" for x in customer_monthly['Себестоимость']]
