...
# ==========================================
if page == "📈 Продажи":
    # ===== ДИАГНОСТИКА (удалите после отладки) =====
with st.expander("🔍 Диагностика структуры данных"):
    st.write("**Колонки в sales_df:**", list(sales_df.columns))
    st.write("**Колонки в df_year:**", list(df_year.columns))
    st.write("**has_cost_column =", 'Себестоимость' in df_year.columns)
    st.write("**Первые 3 строки df_year:**")
    st.dataframe(df_year.head(3))
